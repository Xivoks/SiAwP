...
BEGIN
  ...
  IF v_salary < 2000 OR v_salary > 26000 THEN
    ...
    RAISE_APPLICATION_ERROR(-20012, 'Salary out of permitted range');
  END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_employees_auto_increment
...
CREATE OR REPLACE TRIGGER trg_prevent_job_grades_modification
BEFORE INSERT OR UPDATE OR DELETE ON job_grades
BEGIN
  RAISE_APPLICATION_ERROR(-20013, 'Operation not allowed on JOB_GRADES');
END;
/

CREATE OR REPLACE TRIGGER trg_keep_salary_bounds
